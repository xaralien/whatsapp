       ...
       <Tabs>
          ...
          <List>
            <ListItem avatar style={{marginBottom:10}}>
              <Left>
                <Thumbnail source={require("./assets/images/fufu.jpg")} />
              </Left>
              <Body>
            ...
            <ListItem avatar style={{marginBottom:10}}>
              <Left>
                <Thumbnail source={require("./assets/images/jobob.jpg")} />
              </Left>
              <Body>
                <Text>Zimbad Zembad</Text>
                <Text note>OTW</Text>
              </Body>
              <Right>
                <Text note>10:25 am</Text>
              </Right>
              <View>
          ...
          <ListItem avatar style={{marginBottom:5}} noBorder>
              <Left>
                <Thumbnail source={require("./assets/images/neat.png")} />
            ...
            <ListItem avatar style={{marginBottom:5}}>
              <Left>
                <Thumbnail source={require("./assets/images/jobob.jpg")}  style={{padding:5, backgroundColor:"#ffffff",borderWidth: 2.5, borderColor: "#075e54"}} />
              </Left>
              <Body>
                <Text>Zimbad Zembad</Text>
            ...
            <ListItem avatar style={{marginBottom:5}}>
              <Left>
                <Thumbnail source={require("./assets/images/fufu.jpg")} style={{borderWidth: 2.5, borderColor: "#dbd8d5"}} />
              </Left>
              <Body>
                <Text>Kumar Pratik</Text>
          ...
          <ListItem avatar style={{marginBottom:5}}>
              ...
              <Body>
                <Text>Zimbad Zembad</Text>
                <Text note><Icon name="arrow" style={{size:10, color:'green'}}/>Today 10.23 pm</Text>
              </Body>
              <Right>
                <Button transparent>
